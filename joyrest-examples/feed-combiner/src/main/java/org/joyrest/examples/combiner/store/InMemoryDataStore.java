...
public interface InMemoryDataStore {
     ...
     * @param data new data to be stored under the given {@code key}. May be {@code null}, in which case the data will be
     *             removed from the
     *            store.
     * @return {@code null} if there are no data stored under the given {@code key} or any replaced data previously stored
     * under the
     *         {@code key}.
     *
     ...
     *
     * The method retrieves the data stored under a unique {@code key} from the data store and returns the data cast into the
     * Java type
     ...
     * @throws ClassCastException in case the data stored under the given {@code key} cannot be cast to the Java type
     * represented by
     *             {@code type} parameter.
     */
     ...
     *
     * Any content previously stored in the data store will be discarded and replaced with the content loaded from the input
     * stream.
     *
