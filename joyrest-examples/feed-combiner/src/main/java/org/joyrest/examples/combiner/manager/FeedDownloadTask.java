...
public class FeedDownloadTask implements Runnable {
	...
	/**
	 * The exception which is used for transform {@link SyndEntry synd entry} to
	 * this application-friendly version {@link FeedEntry feed entry}.
	 * <p>
	 * The class implements {@link Function function interface} for a purpose to
	 * use it in the {@link Stream stream}.
	 * </p>
	 * 
	 * @author Petr Bouda
	 **/
