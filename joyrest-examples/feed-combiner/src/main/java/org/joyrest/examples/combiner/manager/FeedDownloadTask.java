...
/**
 * An instance of this class implements the {@link Runnable#run() run method} with functionality of downloading all entries
 * from feed which
 * are available. These entries are added into the combined feed and stored in the database again (storing means rewrite
 * previous combined
...
public class FeedDownloadTask implements Runnable {
    ...
    /**
     * The exception which is used for transform {@link SyndEntry synd entry} to this application-friendly version {@link
     * FeedEntry feed
     * entry}.
     * <p>
