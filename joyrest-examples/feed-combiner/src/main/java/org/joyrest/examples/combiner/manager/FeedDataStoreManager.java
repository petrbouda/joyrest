...
/**
 * This class is used for purposes of processing and listening a new saved or removed entities in {@link InMemoryDataStore} and according to
 * its {@link CombinedFeed#getRefreshPeriod()} property is able to give an entity into the queue for another processing which is dedicated
 * to consumers.
 * 
 * @author Petr Bouda
 * */
