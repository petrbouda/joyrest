...
public abstract class TypedControllerConfiguration extends AbstractControllerConfiguration {
	...
	protected final <REQ> Route get(RouteAction<Request<REQ>, Response<?>> action, RequestType<REQ> req) {
		return createEntityRoute(HttpMethod.GET, "", action, req, null);
	}

	protected final <REQ> Route get(String path, RouteAction<Request<REQ>, Response<?>> action, RequestType<REQ> req) {
		return createEntityRoute(HttpMethod.GET, path, action, req, null);
	}

	protected final <RESP> Route get(RouteAction<Request<?>, Response<RESP>> action, ResponseType<RESP> resp) {
		return createEntityRoute(HttpMethod.GET, "", action, null, resp);
	}

	protected final <RESP> Route get(String path, RouteAction<Request<?>, Response<RESP>> action, ResponseType<RESP> resp) {
