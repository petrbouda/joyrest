...
public interface ControllerConfiguration {
	...
	/**
	 * Method contains a configuration of {@link Route} classes and other
	 * objects which are in a connection with these routes.
	 *
	...
	/**
	 * Provides set routes configured in {@link #initialize()} method of the
